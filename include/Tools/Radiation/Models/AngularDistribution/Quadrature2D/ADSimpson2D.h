#ifndef _ANGULAR_DISTRIBUTION_SIMPSON_2D_H
#define _ANGULAR_DISTRIBUTION_SIMPSON_2D_H
...
namespace __Radiation {
    class ADSimpson2D : public ADQuadrature2D {
        private:
            unsigned int nsamples;
        public:
            ADSimpson2D(ADEmission*, Detector*, unsigned int);
...
#endif/*_ANGULAR_DISTRIBUTION_SIMPSON_2D_H*/
