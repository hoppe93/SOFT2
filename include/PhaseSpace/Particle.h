...
class Particle {
	...
	private:
		...
		int momentum1, momentum2;		// Types of momentum coordinates (values
										// according to 'COORDINATE_XXX' below)
	...
	public:
		Particle();
		void InitializeMomentum(const int, const int, const slibreal_t, const slibreal_t, const slibreal_t, const slibreal_t, const slibreal_t, const slibreal_t);
        ...
        int GetPositionType()       const {return this->position_type;}
		...
		void SetPositionType(const int v)       { this->position_type = v; }
